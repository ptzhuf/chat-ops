package com.taoqicar.chatops.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ChatOps");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ChatOps");
        ...
        config.getMapConfigs().put("com.taoqicar.chatops.domain.*", initializeDomainMapConfig(jHipsterProperties));
